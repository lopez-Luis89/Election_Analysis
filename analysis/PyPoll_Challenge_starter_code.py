...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dic:
        ...
        county_votes = county_dic[county_name]
        # 6c: Calculate the percentage of votes for the county.
        county_percentage = float(county_votes) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        results = (f" \n{county_name}:{county_votes}, {county_percentage:.1f}%")
        print(results, end ="")
         # 6e: Save the county votes to a text file.
        txt_file.write(results)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (county_votes > largest_votes) and (county_percentage > winning_county):
    ...
    county_results =     (f"\n-----------------------\n"
                          f"Largest Turnout:"
                          f"{largest_votes}: {largest_county}\n"
                          f"-----------------------")
